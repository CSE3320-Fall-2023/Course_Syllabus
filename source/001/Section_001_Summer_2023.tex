...
\begin{center}
{\bf CSE 3320.001 Operating Systems \linebreak{} Summer 2023\linebreak{} \ \
}
\end{center}
...
\vskip.25in
 ...
 \vskip.25in
\noindent\textbf{Section Information:} CSE3320 Section 001 
 \vskip.25in
\noindent\textbf{Time and Place of Class Meetings}:  MW 6:00PM - 7:50 PM NH 112 
\vskip.25in
...
https://join.slack.com/t/cse3320/shared\_invite/zt-ck6lh5lu-AgrjeNKnkIzTrqQUm9r5MQ
...
\begin{flushleft}
Drop Deadline \dotfill July 24th\\
Midterm Exam \dotfill June 28th (tentative)\\
Final  \dotfill August 10th 6:00pm - 8:00pm (fixed)\\
\end{flushleft}
\end{minipage}
\end{center}
\vskip.25in
...
\cline{1-2}
Programs   &50\% &  &  &  \\ \cline{1-2}
Exam         &15\% &  &  &  \\ \cline{1-2}
Final Exam & 35\% &  &  &  \\ \cline{1-2}
\end{tabular}
\end{table}

\noindent No make-up exams will be given.  Exceptions will only be made for documented emergencies, in strict adherence to UTA policy. All exceptions must have formal documentation.
\\\\
...
\noindent
All code written in this course must remain in private repositories.  Any public posting of the code or code repositories will be considered an intentional act of academic dishonesty and will result in a failing grade for the course.\\\\
...
\includegraphics[scale=.4]{evacuation.png} 
...
\center{
\includegraphics[scale=0.70]{schedule.png} 
}
\end{document}